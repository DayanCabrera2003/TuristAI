...
class MetaheuristicasItinerario:
    ...
    def algoritmo_genetico_itinerario(self, actividades_disponibles, tam_poblacion=30, generaciones=50):
        """
        ...
        for _ in range(generaciones):
            ...
            while len(nueva_poblacion) < tam_poblacion:
                ...
                hijo1 = self.mutar(hijo1, actividades_disponibles)
                hijo2 = self.mutar(hijo2, actividades_disponibles)
    ...
    def pso_itinerario(self, actividades_disponibles, num_particulas=30, iteraciones=50, w=0.5, c1=1.5, c2=1.5):
        """
        ...
        for _ in range(iteraciones):
            for i, particula in enumerate(particulas):
                ...
                for idx in velocidades[i]:
                    ...
                    opciones = [a for a in actividades_disponibles if a not in nueva_particula]
                    if opciones:
